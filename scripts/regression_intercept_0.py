...
summary_data.insert(0, ["Intercept", "0.00000", "N/A", "N/A", "N/A", "N/A", "N/A"])
...
fig, (ax1, ax2, ax3) = plt.subplots(nrows=3, ncols=1, figsize=(12, 8), gridspec_kw={'height_ratios': [1, 1.5, 2]})

# Regression statistics table
ax1.axis('off')
ax1.set_title("Regression Statistics", fontsize=14, pad=3)
reg_stats_table = ax1.table(cellText=reg_stats,
...
# ANOVA table
ax2.axis('off')
ax2.set_title("ANOVA", fontsize=14, pad=3)
anova_table = ax2.table(cellText=anova_data,
...
ax3.axis('off')
ax3.set_title("Multiple Regression Summary", fontsize=14, pad=3)
summary_table = ax3.table(cellText=summary_data,
